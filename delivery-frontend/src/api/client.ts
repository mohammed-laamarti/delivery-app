import type { DeliveryPackage, DeliveryResult, Driver, PackageStatus } from '../types'
...
const statusFromApi: Record<string, PackageStatus> = {
  TO_DELIVER: 'A LIVRER', ASSIGNED: 'AFFECTE', IN_DELIVERY: 'EN LIVRAISON', DELIVERED: 'LIVRE', POSTPONED: 'REPORTE', RETURNED: 'RETOUR',
}

const statusToApi: Record<PackageStatus, string> = {
  'A LIVRER': 'TO_DELIVER', AFFECTE: 'ASSIGNED', 'EN LIVRAISON': 'IN_DELIVERY', LIVRE: 'DELIVERED', REPORTE: 'POSTPONED', RETOUR: 'RETURNED',
}
